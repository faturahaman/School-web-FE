  ...
  const programs = [
    {
      ...
      description:
        "Program Keahlian yang di mempelajari pengembangan aplikasi, web, dan game development",
      students: "100 siswa",
      duration: "3 tahun",
      ...
      image: "/image/Software Consulting and Development Company.webp",
    },
    {
      id: 2,
      title: "Analis Kimia (AK)",
      description:
        "Program Keahlian yang fokus pada analisis dan pengujian bahan kimia untuk berbagai industri",
      students: "100 siswa",
      duration: "4 tahun",
      subjects: "Mata Pelajaran:",
      tags: [
      ...
      image: "/image/download (3).webp",
    },
    {
      id: 3,
      title: "Farmasi (FM)",
      description:
        "Program Keahlian yang mempelajari bidang farmasi untuk industri obat dan kesehatan",
      students: "100 siswa",
      duration: "3 tahun",
      subjects: "Mata Pelajaran:",
      tags: [
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
            ...
            mempersiapkan siswa menjadi tenaga kerja profesional yang siap
